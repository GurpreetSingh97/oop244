...
// Description: In the main function we are asking for the number of kingdoms, then their names and populations. Later we are displaying the name of the kingdom which was entered first.
//				Finally we are showing each kingdom's name and it's population and total population of all the kingdoms in the end.
//
//
// Revision History
///////////////////////////////////////////////////////////
