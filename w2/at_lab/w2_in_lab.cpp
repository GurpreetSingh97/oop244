...
// Description: In the main function, we are asking for the number of kingdoms and then asking for their name and their population.
//				Finally we are displaying the kingdom's name and population, which was entered first.
//
// 
//
// Revision History
